...
class CompleteState(State):    
    ...
    def __get_values_from_player(self, player):
        ...
        other_players = game.get_players()
        player_position = player.get_position()
        
        for other_player in other_players:
            if other_player.get_position != player_position:
                other_player_state = TableFullState.build_by_player(other_player)
    ...
    def get_total_numbers(num_players):
        ...
        base = 1        
        base *= PlayerFullState.get_total_numbers()
        base *= TableFullState.get_total_numbers() * num_players
    ...
    def get_number_of_observations(num_players):
        ...
        return PlayerFullState.get_number_of_observations() + (TableFullState.get_number_of_observations() * num_players)
