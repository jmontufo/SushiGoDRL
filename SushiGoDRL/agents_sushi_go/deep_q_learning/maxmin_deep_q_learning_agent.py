...
class MaxminDQLearningTorchAgent(Agent):
    
    def __init__(self, player, filename, state_type, learning_rate, N):
        
        super(MaxminDQLearningTorchAgent, self).__init__(player, filename)
    ...
    def choose_action(self, legal_actions, rival_legal_actions = None):
        ...
        for j in range(self.N):
            q_values.append(self.dq_network.get_Q(adapted_state, j).detach())
...
class MaxminDQLearningTorchAgentPhase1(MaxminDQLearningTorchAgent):
    
    def __init__(self, player = None):
        
        super(MaxminDQLearningTorchAgentPhase1, self).__init__(player, "MaxminDQL_2p_CompleteMemoryState_lr0.0005_d0.995_wr-1_N4_40000_Phase1-39", CompleteMemoryState, 0.0005, 4)
      
    def trained_with_chopsticks_phase(self):
        return True  
   
class MaxminDQLearningTorchAgentPhase2(MaxminDQLearningTorchAgent):
    
    def __init__(self, player = None):
        
        super(MaxminDQLearningTorchAgentPhase2, self).__init__(player, "MaxminDQL_2p_CompleteMemoryState_lr0.0005_d0.995_wr-1_N2_40000_Phase2-39", CompleteMemoryState, 0.0005, 2)
      
    def trained_with_chopsticks_phase(self):
        return True  
        
class MaxminDQLearningTorchAgentPhase3(MaxminDQLearningTorchAgent):
    
    def __init__(self, player = None):
        
        super(MaxminDQLearningTorchAgentPhase3, self).__init__(player, "MaxminDQL_2p_CompleteMemoryState_lr0.00075_d0.99_wr-1_N2_40000_Phase3-39", CompleteMemoryState, 0.00075, 2)
